...
//-------------FUNCTIONFEST---------------//
function firstAlt() {
	document.getElementById('headline-intro').innerHTML = "Wanna see something else?"
};
...
function callBlue() {
	setTimeout("$('#blurestrain').animate({opacity: '1'},600);", 1100);
	$('#blurestrain').css('pointer-events', 'auto');
}

function callRed() {
	setTimeout("$('#redrestrain').animate({opacity: '1'},600);", 1100);
...
function alternates() {
	...
	case 4:
		document.getElementById('headline-intro').innerHTML =
			"If you can understand Brazilian Portuguese how about checking the <a href='http://blog.lucasflicky.com'>Blog</a> out? ";
		break;

	case 5:
		document.getElementById('headline-intro').innerHTML =
			"Need Help? Toss me a message at the <a onclick=\"goTo(\'#contactw\');\">Contact Form</a>";
		break;
	...
	case 10:
		document.getElementById('headline-intro').innerHTML =
			"I wonder what is keeping you around for this long...";
		break;

	case 11:
		document.getElementById('headline-intro').innerHTML =
			"You know, you've came to the home screen kinda, 10 times already";
		break;

	case 12:
		document.getElementById('headline-intro').innerHTML =
			"Maybe you're having fun with the homepage sliding animation?";
		break;

	case 13:
		document.getElementById('headline-intro').innerHTML =
			"I see, but we're missing the point here.";
		break;

	case 14:
		document.getElementById('headline-intro').innerHTML =
			"I think that at the <a href='http://blog.lucasflicky.com'>Blog</a> you would spend this time more usefully...";
		break;
	...
	case 16:
		document.getElementById('headline-intro').innerHTML =
			"Did I ever mention you can schedule a personal meeting if you prefer?";
		break;

	case 17:
		document.getElementById('headline-intro').innerHTML =
			"Well, this is, if you are willing to come to Porto Alegre - Brazil, in order to do so";
		break;
...
////////////////////////////
	...
	$("input#email").change(function(){
		if (!$(this).val() == ''){$(this).val().match('@')?$("#email").removeClass('error'):$("#email").addClass('error');}
...
/*
var GALE = document.getElementById("/gallery"); 
('#galer').on('click', function(e) {	GALE.fadeToggle() }

var SOND = document.getElementById("/sounds");
var KONTA = document.getElementById("/contact");
var ABOT = document.getElementById("/about");

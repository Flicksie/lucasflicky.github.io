var gallery = [
	...
	[
	    ...
	    `<span style="font-size:12">
            GIANT TURTLE <i style="font-size:10;">(Art Direction / Rendering)</i>
        </span>
        <span style="position:float; margin-top:-10px;font-size:8; float:right; text-align:right;">
	...
	[
        ...
        'ilus',
	    `<span style="font-size:12">
            THE BEAR <i style="font-size:10;">(Art Direction / Rendering)</i>
        </span>
        <span style="position:float; margin-top:-10px;font-size:8; float:right; text-align:right;">
            <b>PROJECT: </b>#### Card Game<br>
	        <b>ASSISTANT(S): </b>Pamela Grether <i>(Sketch)<i><br>
	...
	[
        ...
        'ilus',
        `<span style="font-size:12">
            MOUNTAIN DRAGON <i style="font-size:10;">(Art Direction / Rendering)</i>
        </span>
        <span style="position:float; margin-top:-10px;font-size:8; float:right; text-align:right;">
            <b>PROJECT: </b>#### Card Game<br>
	...
	[
        ...
        'ilus',
		`<span style="font-size:12">
            MISCHIEVOUS FAIRY <i style="font-size:10;">(Illustration / Rendering)</i>
        </span><span style="position:float; margin-top:-10px;font-size:8; float:right; text-align:right;">
		      <b>PROJECT: </b>#### Card Game<br>
		</span>`
    ],
	[
	...
	[
        ...
        'ilus',
        `<span style="font-size:12">
            URBAN ELVES <i style="font-size:10;">(Art Direction / Rendering)</i>
        </span>
        <span style="position:float; margin-top:-10px;font-size:8; float:right; text-align:right;">
            <b>PROJECT: </b>#### Card Game<br>
	...
	[
        ...
        'paint',
        `<span style="font-size:12">
            ETO - TOKYO GHOUL <i style="font-size:10;">(Collab / Rendering)</i>
        </span>
        <span style="position:float; margin-top:-10px;font-size:8; float:right; text-align:right;">
	...
	[
        ...
        'skt',
        `<span style="font-size:12">
            PHUSE <i style="font-size:10;">(Character Design / Illustration)</i>
        </span>
        <span style="position:float; margin-top:-10px;font-size:8; float:right; text-align:right;">
	...
	[
        ...
        'ilus',
        `<span style="font-size:12">
            LICH <i style="font-size:10;">(Art Direction / Rendering)</i>
        </span>
        <span style="position:float; margin-top:-10px;font-size:8; float:right; text-align:right;">
            <b>PROJECT: </b>#### Card Game<br>
...
function newPic(category,path,imgname,optName,i,projName){
    ...
    class="blockelement element ${category} isotope-item isotope-item">
        <div style="position:absolute;z-index:0;width:100%;margin-top:25px;text-align:center;">
        </div>
        <div class='blockcontent'>
            <div class='elements'>
                <div>
                    <div class='wsite-image'>
                        <a class='w-fancybox' rel='lightbox[galleryfeed]' title='${optName}' href='./${path+imgname}.png'
                            onclick='if(!lightboxLoaded) return false'>
                            <img src='./${path+imgname}.png' alt='${optName}' style='width:100%;max-width:800px'>
                        </a>
                    </div>
                </div>
            </div>
